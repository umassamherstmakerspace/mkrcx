<script lang="ts">
	...
	import { getSelf, getUserById, key } from '$lib/src/leash';
	import type { User } from '$lib/src/types';
	import { Alert, AppShell, Header, Seo, SimpleGrid, Skeleton, Tabs, Text } from '@svelteuidev/core';
    ...
    async function getUser() {
        user = await getSelf();
        userPlaceholder = JSON.parse(JSON.stringify(user, (key, value) => (typeof value === 'function') ? null : (typeof value === 'object') ? null : value));
    }
</script>
