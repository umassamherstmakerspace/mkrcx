...
NOT SETTLED. Shira finds the September 3 page too busy and confusing. Before changing the page,
settle with her, one question at a time: who the page is for, the few high-level questions it must
answer, and what it should leave out. Record the answers under "Settled decisions" below. Do not
add charts, filters, or data sources until that section has content.
...
Run the high-level question session with Shira and fill in "Goal" and "Settled decisions".
